...
__decorate([
    (0, typeorm_1.OneToOne)(() => User_1.User, (user) => user.credential) // Para especificar la relacion bidireccional hacemos lo mismo quie en User. 
    ,
    __metadata("design:type", User_1.User // user con minuscula es la columna.
    )
